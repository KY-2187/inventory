...
class _BuyPageState extends State<BuyPage> {
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                MyInputField(
                  title: "Place Bought",
                  hint: "Enter where you bought it",
                ...
                SizedBox(height: 16),
                SubmitButton(
                    buttonLabel: "Submit", onTap: () => _validateForm())
              ],
            ),
          ),
        ));
  ...
  _validateForm() async {
    if (_selectedItem != "Select Item" &&
        ...
        _priceController.text.isNotEmpty) {
          int newQuantity = await _addQuantity();
  ...
  _addBuyToDb() async {
    int value = await _buyController.addBuy(
        buy: Buy(
      itemName: _selectedItem,
      buyQuantity: int.parse(_quantityController.text),
    ...
    return PreferredSize(
      ...
      child: Container(
          ...
          child: AppBar(
            ...
            elevation: 0.5,
            backgroundColor: Colors.white,
            title: Text("Buy Item", style: titleStyle),
          )),
    );
  }
